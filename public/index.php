...
$app->get('/accounts', function (Request $request, Response $response) {
    ...
    $response->getBody()->write(json_encode(array("accounts" => $accounts)));
});

//getting all timesheets
$app->get('/timesheets', function (Request $request, Response $response) {
    $db = new DbOperation();
    $timesheets = $db->getAllTimesheets();
    $response->getBody()->write(json_encode(array("timesheets" => $timesheets)));
});
...
$app->get('/activities', function (Request $request, Response $response) {
    ...
    $response->getBody()->write(json_encode(array("activities" => $activities)));
});

//getting all cost_centres
$app->get('/cost_centres', function (Request $request, Response $response) {
    $db = new DbOperation();
    $cost_centres = $db->getAllCostCentres();
    $response->getBody()->write(json_encode(array("cost_centres" => $cost_centres)));
});
...
$app->get('/projects', function (Request $request, Response $response) {
    ...
    $response->getBody()->write(json_encode(array("projects" => $projects)));
});
...
$app->get('/roles', function (Request $request, Response $response) {
    ...
    $response->getBody()->write(json_encode(array("roles" => $roles)));
});
